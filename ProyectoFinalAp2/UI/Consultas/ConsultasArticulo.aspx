<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultasArticulo.aspx.cs" Inherits="ProyectoFinalAp2.UI.Consultas.ConsultasArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Articulo</div>
                ...
                <asp:GridView ID="DatosGridView"
                    ...
                    <Columns>
                        <asp:HyperLinkField ControlStyle-ForeColor="blue"
                            ...
                            DataNavigateUrlFormatString="~/UI/Registros/RegistroArticulo.aspx?Id={0}"
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="max-width: 750px!important; min-width: 750px!important">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">REPORTE ARTICULO</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <%--Viewer--%>
                        <rsweb:ReportViewer ID="ArticuloReportViewer" runat="server" ProcessingMode="Local" Height="600px" Width="700px">
