<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultasDepartamento.aspx.cs" Inherits="ProyectoFinalAp2.UI.Consultas.ConsultasDepartamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Departamento</div>
                ...
                <asp:GridView ID="DatosGridView"
                    ...
                    <Columns>
                        <asp:HyperLinkField ControlStyle-ForeColor="blue"
                            DataNavigateUrlFields="DepartamentoId"
                            DataNavigateUrlFormatString="~/UI/Registros/RegistroDepartamento.aspx?Id={0}"
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="max-width: 600px!important; min-width: 600px!important">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">REPORTE DEPARTAMENTO</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <%--Viewer--%>
                        <rsweb:ReportViewer ID="DepartamentoReportViewer" runat="server" ProcessingMode="Local" Height="400px" Width="500px">
