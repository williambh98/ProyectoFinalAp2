<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultasEntrada.aspx.cs" Inherits="ProyectoFinalAp2.UI.Consultas.ConsutasEntrada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta Inventario</div>
                ...
                <asp:GridView ID="DatosGridView"
                    ...
                    <Columns>
                        <asp:HyperLinkField ControlStyle-ForeColor="blue"
                            ...
                            DataNavigateUrlFormatString="~/UI/Registros/RegistroEntrada.aspx?Id={0}"
            ...
            <div class="modal-dialog" style="max-width: 700px!important; min-width: 700px!important">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">REPORTE CAPINVENTARIO</h5>
