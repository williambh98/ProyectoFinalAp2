<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultasProveedores.aspx.cs" Inherits="ProyectoFinalAp2.UI.Consultas.ConsultasProveedores" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div>
                <div class="col-md-2">
                    <asp:DropDownList ID="BuscarPorDropDownList" runat="server" CssClass="form-control input-sm">
                        ...
                        <asp:ListItem>IDProveedor</asp:ListItem>
                ...
                <asp:GridView ID="DatosGridView"
                    ...
                    <Columns>
                        <asp:HyperLinkField ControlStyle-ForeColor="blue"
                            ...
                            DataNavigateUrlFormatString="~/UI/Registros/RegistroProveedores.aspx?Id={0}"
            ...
            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog" style="max-width: 650px!important; min-width: 650px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="ProveedoresReportViewer" runat="server" ProcessingMode="Local" Height="500px" Width="600px">
